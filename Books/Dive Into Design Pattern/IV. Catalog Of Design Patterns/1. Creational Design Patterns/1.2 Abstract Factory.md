...
- Đầu tiên mà mô hình Abstract Factory gợi ý là declare rõ ràng các inteerfaces cho từng product riêng biệt của product family(e.g., chair, sofa of coffee table).
