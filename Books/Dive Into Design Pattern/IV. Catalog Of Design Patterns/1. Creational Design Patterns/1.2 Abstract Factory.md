...
- 5. **Tạo code khởi tạo factory ở nơi nào đó trong ứng dụng**:
	- Tạo factory initialization code ở đâu đó trong app, nó sẽ khởi tạo một trong các concrete factory classes (tùy vào các variant của product), tùy thuộc vào configuration or env hiện tại
