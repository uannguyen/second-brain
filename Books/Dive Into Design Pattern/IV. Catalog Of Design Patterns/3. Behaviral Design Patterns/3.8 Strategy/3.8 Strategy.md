...
- Bắt kỳ thay đổi nào với một trong các algorithms, cho dù sửa một simple bug hay một chút điều chỉnh of the street score đều sẽ ảnh hưởng đến toàn bộ class, tăng nguy cơ gây lỗi 
