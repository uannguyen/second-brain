...
- Trong ex này, Observer pattern ch phép text editor object thông báo đến các service objects khác về sự thay đổi state của nó
...
- Trong implementation này, editor class không tự duy trì subscription list
	- Nó delegates việc này cho special helper object xử lý
