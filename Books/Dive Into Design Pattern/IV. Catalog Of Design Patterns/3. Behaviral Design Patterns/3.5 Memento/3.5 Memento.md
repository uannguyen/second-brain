...
- Tại sao không khai báo fields ở dạng public ?
	- Trong tương lai, editor classes có thể phải refactor lại, thêm hoặc xóa fields
	- Nghe khá dễ dàng, nhưng điều này ảnh hưởng đến một chuỗi các classes chịu trách nhiệm copying state của các objects bị ảnh hưởng
